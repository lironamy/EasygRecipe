function getSuctionPattern(i, patternsStartOne, patternsStartTwo, patternsStartThree, patternsStartFour, hrauselValues, diversityValue) {
    const patterns = [];
...
module.exports = { getSuctionPattern };